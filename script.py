...
def compileTask1():
    os.system("gcc LAB01-TASK01.c -o LAB01-TASK01 && LAB01-TASK01")
    if os.path.exists("LAB01-TASK01.exe"):
        os.remove("LAB01-TASK01.exe")

def compileTask2():
    os.system("gcc LAB01-TASK02.c -o LAB01-TASK02 && LAB01-TASK02")
    if os.path.exists("LAB01-TASK02.exe"):
        os.remove("LAB01-TASK02.exe")

def compileTask3():
    os.system("gcc LAB01-TASK03.c -o LAB01-TASK03 && LAB01-TASK03")
    if os.path.exists("LAB01-TASK03.exe"):
        os.remove("LAB01-TASK03.exe")

def compileTask4():
    os.system("gcc LAB01-TASK04.c -o LAB01-TASK04 && LAB01-TASK04")
    if os.path.exists("LAB01-TASK04.exe"):
        os.remove("LAB01-TASK04.exe")

def compileTask5():
    os.system("gcc LAB01-TASK05.c -o LAB01-TASK05 && LAB01-TASK05")
